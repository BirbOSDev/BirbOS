...
if "%input%"=="help" (echo Commands are: help, owo, birb, calculate, reboot, shutdown, stfu, guess-game, clear, changelog, about, logoff, runapp, writedoc, readdoc, folder. && goto :prompt2 )
